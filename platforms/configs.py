...
PLATFORM_CONFIGS = {
    ...
    'psp': {
        ...
        'forum_id': '1352',
        'filename': os.path.join(DATA_DIR, 'psp_games.json'),
    ...
    'ps1': {
        ...
        'forum_id': '908',
        'filename': os.path.join(DATA_DIR, 'ps1_games.json'),
    ...
    'wiiu': {
        'name': 'Nintendo Wii U',
        'forum_id': '773',
        'filename': os.path.join(DATA_DIR, 'wiiu_games.json'),
    ...
    'wii': {
        'name': 'Nintendo Wii',
        'forum_id': '773',
        'filename': os.path.join(DATA_DIR, 'wii_games.json'),
    ...
    'gamecube': {
        ...
        'forum_id': '773',
        'filename': os.path.join(DATA_DIR, 'gamecube_games.json'),
    ...
    'nes': {
        ...
        'forum_id': '129',
        'filename': os.path.join(DATA_DIR, 'nes_games.json'),
    ...
    'snes': {
        ...
        'forum_id': '129',
        'filename': os.path.join(DATA_DIR, 'snes_games.json'),
    ...
    'n64': {
        'name': 'Nintendo 64',
        'forum_id': '129',
        'filename': os.path.join(DATA_DIR, 'n64_games.json'),
    ...
    'gba': {
        ...
        'forum_id': '129',
        'filename': os.path.join(DATA_DIR, 'gba_games.json'),
    ...
    'gbc': {
        ...
        'forum_id': '129',
        'filename': os.path.join(DATA_DIR, 'gbc_games.json'),
    ...
    'sega_md': {
        ...
        'forum_id': '129',
        'filename': os.path.join(DATA_DIR, 'sega_md_games.json'),
    ...
    'sega_ms': {
        ...
        'forum_id': '129',
        'filename': os.path.join(DATA_DIR, 'sega_ms_games.json'),
    ...
    'sega_gg': {
        'name': 'Sega Game Gear',
        'forum_id': '129',
        'filename': os.path.join(DATA_DIR, 'sega_gg_games.json'),
    ...
    'sega_cd': {
        ...
        'forum_id': '129',
        'filename': os.path.join(DATA_DIR, 'sega_cd_games.json'),
    ...
    'sega_32x': {
        'name': 'Sega 32X',
        'forum_id': '129',
        'filename': os.path.join(DATA_DIR, 'sega_32x_games.json'),
    ...
    'ps2': {
        ...
        'forum_id': '357',
        'filename': os.path.join(DATA_DIR, 'ps2_games.json'),
    ...
    'psvita': {
        ...
        'forum_id': '595',
        'filename': os.path.join(DATA_DIR, 'psvita_games.json'),
    ...
    'dreamcast': {
        'name': 'Sega Dreamcast',
        'forum_id': '968',
        'filename': os.path.join(DATA_DIR, 'dreamcast_games.json'),
    ...
    '3ds': {
        'name': 'Nintendo 3DS',
        'forum_id': '774',
        'filename': os.path.join(DATA_DIR, '3ds_games.json'),
    ...
    'nds': {
        'name': 'Nintendo DS',
        'forum_id': '774',
        'filename': os.path.join(DATA_DIR, 'nds_games.json'),
